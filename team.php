...
<head>
    <meta charset="utf-8">
    <title>Advogate - Lawyer and Attorney </title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Advogate - Lawyer and Attorney Website Template" name="description">
    ...
    <div id="wrapper">
        ...
        <div class="no-bottom no-top" id="content">
            ...
            <section data-bgcolor="#111111" class="text-light">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-5">
                            ...
                            <p>Javed Haleem (Advocate High Court CEO at Advogate). Mr. Javed, besides being Partner at Advogate is highly skilled lawyer with extensively rich experience in diverse areas of litigation including but not limited to all sections of Civil as well as criminal litigation. Mr. Javed has core expertise in dealing with the trials of cases especially at Evidence stage and this is core area where his expertise is being utilized by Advogate for the benefit and advantage of clients. He is looking the all matters pertaining to Financial Institutions. He is regularly appearing in Banking Courts, Special Court (Offences in Bank) and Suits and appeals in High Court. Mr. Javed got enrolled with the Bar and started practicing Law in 1994 and ever since then he’s been attached with Advogate</p>
                ...
                <div class="image-container col-md-6 pos-right" data-bgimage="url(images/team/4.png) center"></div>
            </section>
            <section data-bgcolor="#111111" class="text-light">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-5 offset-md-7">
                            ...
                            <p>Abdul Karim Khan (Advocate High Court) is a partner with Advogate and a seasoned Lawyer with decades of extensively bounding experience in Litigation and Managing the Legal Affairs of Government based Organizations such as Karachi Water & sewerage Board & S.I.T.E. Mr. Khan has an incomparably piercing reputation of being highly dedicated to, and honest with, his work and the clients he works for coupled with the output and results he generates for the clients. Mr. Khan has proficient expertise in Civil Litigation in general and in Constitution Petitions in particular especially when it comes to litigation by consumers and employees of a large scale complex organization, not to mention the number of important reported cases under his belt.</p>
                            <div class="social-icons s1">
                                <a href="#"><i class="fa fa-facebook fa-lg"></i></a>
                                <a href="#"><i class="fa fa-twitter fa-lg"></i></a>
                                <a href="#"><i class="fa fa-linkedin fa-lg"></i></a>
                ...
                <div class="image-container col-md-6" data-bgimage="url(images/team/5.png) center"></div>
            </section>
        </div>
        <!-- content close -->
