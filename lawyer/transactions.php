<?php
	...
	$show_modal = false;
		...
		$select_payments_stmt = $conn->prepare(
			"SELECT * FROM Payments WHERE lawyer_email=:lawyer_email"
		);
		...
		$select_payments_total_stmt = $conn->prepare(
			"SELECT SUM(amount) FROM payments WHERE lawyer_email=:lawyer_email"
		);
...
<head>
    <meta charset="utf-8">
    <title>Advogate- Advoate Wallet</title>
														...
														<div class="row">
																<div class="col">
																		<h3 class="mb-0 font-weight-normal">
																			...
																			?>
																			 Rs.</h3>
																		<p class="text-mute">Total Amount Recieved</p>
																</div>
																<!-- <div class="col-auto">
												...
												echo '<div class="card shadow-sm border-0 mb-3">
																	<div class="card-body">
																		<div class="row align-items-center">
																			...
																			<div class="col pr-0">
																							<h6 class="font-weight-normal mb-1">'.$row['client_email'].'</h6>
