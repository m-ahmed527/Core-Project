...
<head>
    <meta charset="utf-8">
    <title>Advogate- Active Case Page</title>
    ...
    <div id="wrapper">
        ...
        <div class="no-bottom no-top" id="content">
            ...
            <div class="card bg-template shadow mt-4 h-100">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col pl-0 align-self-center">
														<h5 class="mb-1"><!-- Ammy Jahnson --><?php echo $row_user['fullname']; ?><small class="float-right mt-1" style="font-size: small;">
															<?php 
				...
				<div class="container">
					<h6 class="subtitle">Active Cases</h6>
					<?php
						foreach($select_active_case_rslt as $active_case){
							echo '<div class="card shadow border-0 mb-3">
											<div class="card-body">
												<div class="row" >
													<div class="col" onclick="location.href=\''.htmlspecialchars('active_case_detail.php?ucid='.urlencode($active_case['unique_case_id'])).'\'">
														<h5 class="font-weight-normal mb-1">'.$active_case['case_category'].'</h5>
														<p class="text-mute small text-secondary mb-2">'.$active_case['lawyer_email'].'</p>
													</div>
												</div>
												<div class="row">
													<div class="col">
					...
					<!-- <div class="card shadow border-0 mb-3">
							<div class="card-body">
									<div class="row">
											<div class="col">
													<h5 class="font-weight-normal mb-1">Case Name/Category <span class="badge badge-danger small vm text-white">Err</span></h5>
													<p class="text-mute small text-secondary mb-2">Case Status</p>
											</div>
									</div>
									<div class="row">
											<div class="col">
