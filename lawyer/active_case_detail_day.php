<?php
	...
	if(isset($_SESSION['email'], $_SESSION['phone'])){
		...
		if(empty($_GET['ucid']) && empty($_GET['date'])){
			if(!empty($_POST['ucid']) && empty($_GET['date'])){
				$ucid = strip_tags($_POST['ucid']);
				$date = strip_tags($_POST['date']);
			} elseif(empty($_POST['ucid']) && empty($_GET['date'])){
			...
			$select_stmt_case = $conn->prepare(
				...
				case_id=:case_id AND case_date=:case_date"
			);
...
<head>
    <meta charset="utf-8">
    <title>Advogate- A ctive Case Detail Day</title>
...
<body>
    <div id="wrapper">
        ...
        <div class="no-bottom no-top" id="content">
            ...
            <div class="container">
            <!-- page content here -->
            <h6 class="subtitle">Case Details</h6>
            <div class="row">
                <div class="col-12 px-0">
                    <ul class="list-group list-group-flush border-top border-bottom">
										<?php
											foreach($select_rslt_case as $row2){ 
												if(empty($row2['case_file'])){
														echo '<li class="list-group-item">
																		<div class="row align-items-center">
																			<div class="col align-self-center pr-0">
																				<p class="font-weight-bold mb-1">Date/Time </p>
																				<h6 class="font-weight-normal mb-1" style="word-wrap  break-word">'.$row2['case_date'].'</h6>
																			</div>
																			<div class="col-auto mt-1">
																			<p class="font-weight-bold mb-1 text-center">Category </p>
																				<h6 class="font-weight-normal">'.$row2['case_category'].'</h6>
																			</div>
																			<div class="col-auto mt-1 text-center">
																				<p class="font-weight-bold mb-1">Details </p>
																				<h6 class="font-weight-normal" style="word-wrap break-word">'.$row2['case_detail'].'</h6>
																			</div>
																		</div>
																	</li>';
												} elseif(!empty($row2['case_file'])){
														echo '<li class="list-group-item">
																		<div class="row align-items-center">
																			<div class="col align-self-center pr-0">
																			<p class="font-weight-bold mb-1">Date/Time </p>
																				<h6 class="font-weight-normal mb-1">'.$row2['case_date'].'</h6>
																			</div>
																			<div class="col-auto mt-1">
																				<p class="font-weight-bold mb-1 text-center">Category </p>
																				<h6 class="font-weight-normal">'.$row2['case_category'].'</h6>
																			...
																			<div class="col-auto mt-1">
																				...
																				<a href="'.$row2['case_file'].'" target="_blank">
            ...
            <div class="row">
                <div class="col mt-4" style="text-align-last:center;">
									<!-- <button type="button" class="btn btn-lg btn-default rounded-0" data-toggle="modal" data-target="#casemodal">Add Details</button> -->
									<br>
									<br>
									<?php
