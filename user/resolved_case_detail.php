...
<head>
    <meta charset="utf-8">
    <title>Advogate- User's Resolved Case</title>
																...
																if(empty($row_case_track['case_file'])){
																		echo '<li class="list-group-item">
																						<div class="row align-items-center">
																							...
																							<div class="col-auto mt-1 ">
																								<h6 class="font-weight-normal">'.$row_case_track['case_detail'].'</h6>
																							</div>
																						</div>
																					</li>';
																		...
																		echo '<li class="list-group-item">
																						<div class="row align-items-center">
																							...
																							<div class="col-auto mt-1">
																								<a href="'.$row_case_track['case_file'].'" download>
														...
														?>
															<!-- <ul class="list-group list-group-flush border-top border-bottom">
																<li class="list-group-item">
																	<div class="row align-items-center">
																		<div class="col align-self-center pr-0">
																			<h6 class="font-weight-normal mb-1">01/01/2020</h6>
