<?php
	...
	if(isset($_SESSION['email'], $_SESSION['phone'])){
		...
		if(isset($_POST['submit'])){
			...
			$select_stmt = $conn->prepare("SELECT * FROM customer WHERE email=:email AND phone=:phone");
...
<head>
    <meta charset="utf-8">
    <title>Advogate- User Profile Edit</title>
        ...
        <div class="no-bottom no-top" id="content">
            ...
            <section>
                <div class="container">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group float-label active">
                            <input type="email" name="email" class="form-control" required="" value="<?php echo $row['email']; ?>" disabled>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group float-label active">
                            <input type="tel" class="form-control" required="" value="<?php echo $row['city']; ?>" name="city">
                            <label class="form-control-label">City</label>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group float-label active">
                            <input type="tel" class="form-control" required="" value="<?php echo $row['zip']; } ?>" name="zip" maxlngth="5">
                ...
                <input type="submit" name="submit" class="btn btn-lg btn-warning text-black btn-block btn-rounded shadow" value="submit">
                <br>
        ...
        <footer>
            <div class="container">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="widget">
                            <a href="indexdata.php"><img alt="" class="img-fluid mb20" src="../images/logo1-light1.png"></a>
                            <address class="s1">
