<?php
	...
	if(isset($_SESSION['email'], $_SESSION['phone'])){
		...
		$select_active_case_rows_rslt = $select_active_case_stmt->rowCount();
...
<head>
    <meta charset="utf-8">
    <title>Advogate- User Active Case Page</title>
            ...
            <section>
                <div class="container">
									...
									<div class="container">
										...
										<?php
											if($select_active_case_rows_rslt > 0){
												foreach($select_active_case_rslt as $active_case){
													echo '<div class="card shadow border-0 mb-3">
																	<div class="card-body">
																		<div class="row" >
																			<div class="col" onclick="location.href=\'active_case_detail.php?ucid='.$active_case['unique_case_id'].'\'">
												...
												echo "<h5 class='text-center'>No active cases</h5>";
											}
										?>
									</div>
								</div>
