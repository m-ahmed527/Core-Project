...
<head>
    <meta charset="utf-8">
    <title>Advogate- User Active Case Detail Day</title>
												...
												if(empty($row2['case_file'])){
														...
														echo '<li class="list-group-item">
																		<div class="row align-items-center">
																			...
																			<div class="col-auto mt-1">
																				<a href="../lawyer/'.$row2['case_file'].'" download>
