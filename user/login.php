<?php
	...
	if(isset($_POST['submit'])){
		if(isset($_POST['email'], $_POST['password'])){
			$select_stmt=$conn->prepare("SELECT * FROM customer");
			$select_stmt->execute();
...
<head>
    <meta charset="utf-8">
    <title>Advogate- User Login</title>
													...
													<div class="col align-self-center px-3 text-center">
														...
														<form class="form-signin mt-3 " method="post" action="login.php">
															<div class="form-group">
																<input type="email" name="email" id="inputEmail" class="form-control form-control-lg text-center" placeholder="Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required autofocus>
															</div>
