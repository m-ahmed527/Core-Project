...
<head>
    <meta charset="utf-8">
    <title>Advogate- User Resolved Case Page</title>
                    ...
                    <div class="row">
											...
											<div class="container">
												...
												<div class="card shadow border-0 mb-3">
															<?php 
																foreach($select_resolved_case_rslt as $row_resolved_case){
																	echo '<div class="card-body">
																					<div class="row" >
																						<div class="col" onclick="location.href=\'resolved_case_detail.php?ucid='.$row_resolved_case['unique_case_id'].'\'">
																							<h5 class="font-weight-normal mb-1">'.$row_resolved_case['case_category'].'</h5>
																							<p class="text-mute small text-secondary mb-2">'.$row_resolved_case['case_status'].'</p>
													...
													<!-- <div class="row">
														<div class="col mt-4" style="text-align-last:center">
															<button type="button" class="btn btn-lg btn-default  rounded-0" data-toggle="modal" data-target="#addmoney">Add Another Case <i class="material-icons">add</i> </button>
														</div>
													</div> -->
											</div>
                </div>
