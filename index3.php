...
<head>
    <meta charset="utf-8" />
    <title>Advogate- Registration</title>
...
<body>
    <div id="wrapper">
            ...
            <div class="container">
                ...
                <div class="topbar-right">
                    <div class="topbar-right">
                        ...
                        <span class="topbar-widget"><a href="index2.php">Login</a></span>
                    </div>
                </div>
        ...
        <div class="no-bottom no-top" id="content">
            ...
            <section class="pt40 pb40 text-light">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6  rtl-lg-left text-sm-center">
                            <a href="user/signup.php" class="btn-custom btn-black light">Signup As User</a>
                        </div>
                        <div class="col-md-6  rtl-lg-left text-sm-center">
                            <a href="lawyer/signup.php" class="btn-custom btn-black light">Signup As Lawyer</a>
                        </div>
                    </div>
                </div>
            </section>
